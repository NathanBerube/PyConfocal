...
"""
This code is used to acquire a single images with specified parameters. The microscope
is initialized bwith the right parameters efore acquiring the image.
