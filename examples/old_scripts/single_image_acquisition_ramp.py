...
# print(rp_scpi_controller.txrx_txt("SOUR1:INITValue?"))
# print(rp_scpi_controller.txrx_txt("SOUR2:INITValue?"))
# print(rp_scpi_controller.txrx_txt("SOUR1:BURS:LASTValue?"))
# print(rp_scpi_controller.txrx_txt("SOUR2:BURS:LASTValue?"))
